...
class Node_GCN(nn.Module):
    ...
    def __init__(self, in_dims, out_dims, num_atoms,dropout=0.):
        ...
        self.dropout = nn.Dropout(dropout)
        self.layer_norm = nn.LayerNorm(in_dims,elementwise_affine = False)
    ...
    def forward(self, inputs, edges,z_0):
        ...
        num_feature = inputs_transform.shape[-1]
        ...
        x_new = F.gelu(x_hidden) - inputs_transform.view(-1,num_feature) + z_0
